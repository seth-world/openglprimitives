...
FontAtlas::FontAtlas(const char* pFont, unsigned int pFontSize, const char* pName,GLenum pTextureEngine)
{
    clear();
    Name=pName;
    FT_Error wFTerr;
    ...
    AtlasUSACII( pFontSize,pTextureEngine);
}

void FontAtlas::AtlasUSACII(FT_UInt pFontSize,GLenum pTextureEngine)
...
//      memset(CharAtlas, 0, sizeof CharAtlas);
    ...
    const FT_ULong MaxCharCode=128; /* USASCII character max value */
     /* Find minimum size for a texture holding all visible ASCII characters */
     for (FT_ULong wChar = 32; wChar < MaxCharCode; wChar++)
     {
